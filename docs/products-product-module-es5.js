...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["products-product-module"], {
  /***/
  "./src/app/products/product-edit/product-edit.component.ts": function srcAppProductsProductEditProductEditComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _state_product_reducer__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../state/product.reducer */
    "./src/app/products/state/product.reducer.ts");
    /* harmony import */


    var _state_product_actions__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    ...
    function ProductEditComponent_div_0_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function ProductEditComponent_div_0_Template_form_ngSubmit_4_listener() {
          ...
          var product_r2 = ctx.ngIf;

          var ctx_r7 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r7.saveProduct(product_r2);
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ProductEditComponent_div_0_Template_button_click_37_listener() {
          ...
          return ctx_r11.cancelEdit(product_r2);
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ProductEditComponent_div_0_Template_button_click_40_listener() {
          ...
          return ctx_r12.deleteProduct(product_r2);
        });
    ...
    function ProductEditComponent_div_2_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var ProductEditComponent = /*#__PURE__*/function () {
      function ProductEditComponent(fb, productService, _store) {
        var _this = this;
        ...
        this.errorMessage = "";
        this.product$ = this._store.select(_state_product_reducer__WEBPACK_IMPORTED_MODULE_4__["getCurrentProduct"]).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["tap"])(function (product) {
      ...
      _createClass(ProductEditComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.productForm.valueChanges.subscribe(function () {
            return _this2.displayMessage = _this2.genericValidator.processMessages(_this2.productForm);
          });
          ...
          this._store.select(_state_product_reducer__WEBPACK_IMPORTED_MODULE_4__["getCurrentProduct"]).subscribe({
            next: function next(product) {
              return _this2.displayProduct(product);
            }
          });
        ...
        key: "cancelEdit",
        value: function cancelEdit(product) {
        ...
        value: function deleteProduct(product) {
          ...
          if (product && product.id) {
            if (confirm("Really delete the product: ".concat(product.productName, "?"))) {
              this.productService.deleteProduct(product.id).subscribe({
                next: function next() {
                  return _this3._store.dispatch(_state_product_actions__WEBPACK_IMPORTED_MODULE_5__["clearCurrentProduct"]());
                },
        ...
        key: "saveProduct",
        value: function saveProduct(originalProduct) {
          var _this4 = this;
          ...
          if (this.productForm.valid) {
            if (this.productForm.dirty) {
              ...
              var product = Object.assign(Object.assign({}, originalProduct), this.productForm.value);

              if (product.id === 0) {
                this.productService.createProduct(product).subscribe({
                  next: function next(p) {
                    return _this4._store.dispatch(_state_product_actions__WEBPACK_IMPORTED_MODULE_5__["setCurrentProduct"]({
                      product: p
                    }));
                  },
                  error: function error(err) {
  ...
  "./src/app/products/product-list/product-list.component.ts": function srcAppProductsProductListProductListComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _state_product_reducer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ../state/product.reducer */
    "./src/app/products/state/product.reducer.ts");
    /* harmony import */


    var _state_product_actions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../state/product.actions */
    "./src/app/products/state/product.actions.ts");
    /* harmony import */
    ...
    function ProductListComponent_div_3_button_2_ng_container_3_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function ProductListComponent_div_3_button_2_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        var currVal_0 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpureFunction1"](7, _c0, (product_r4 == null ? null : product_r4.id) === ((tmp_0_0 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipeBind1"](1, 3, ctx_r3.selectedProduct$)) == null ? null : tmp_0_0.id));
    ...
    var ProductListComponent = /*#__PURE__*/function () {
      function ProductListComponent(productService, _store) {
        _classCallCheck(this, ProductListComponent);

        this.productService = productService;
        this._store = _store;
        this.pageTitle = "Products";
        this.errorMessage$ = this._store.select(_state_product_reducer__WEBPACK_IMPORTED_MODULE_1__["getError"]); // Declarative abroach

        this.displayCode$ = this._store.select(_state_product_reducer__WEBPACK_IMPORTED_MODULE_1__["getShowProductCode"]);
        this.products$ = this._store.select(_state_product_reducer__WEBPACK_IMPORTED_MODULE_1__["getProducts"]); // getCurrentProduct
      ...
      _createClass(ProductListComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          this._store.dispatch(_state_product_actions__WEBPACK_IMPORTED_MODULE_2__["loadProducts"]()); // this.sub = this.productService.selectedProductChanges$.subscribe(
        ...
        value: function productSelected(product) {
          this._store.dispatch(_state_product_actions__WEBPACK_IMPORTED_MODULE_2__["setCurrentProduct"]({
            product: product
    ...
    ProductListComponent.ɵfac = function ProductListComponent_Factory(t) {
      return new (t || ProductListComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_product_service__WEBPACK_IMPORTED_MODULE_3__["ProductService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_ngrx_store__WEBPACK_IMPORTED_MODULE_4__["Store"]));
    };
    ...
    ProductListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function ProductListComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function ProductListComponent_Template_input_change_9_listener() {
  ...
  /***/
  "./src/app/products/product-shell/product-shell.component.ts": function srcAppProductsProductShellProductShellComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var ProductShellComponent = /*#__PURE__*/function () {
      function ProductShellComponent() {
    ...
    ProductShellComponent.ɵfac = function ProductShellComponent_Factory(t) {
      return new (t || ProductShellComponent)();
    };
    ...
    ProductShellComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 5,
      vars: 0,
      consts: [[1, "row"], [1, "col-md-4"], [1, "col-md-8"]],
      ...
      directives: [_product_list_product_list_component__WEBPACK_IMPORTED_MODULE_1__["ProductListComponent"], _product_edit_product_edit_component__WEBPACK_IMPORTED_MODULE_2__["ProductEditComponent"]],
      encapsulation: 2
    });
    /*@__PURE__*/
  ...
  /***/
  "./src/app/products/product.module.ts": function srcAppProductsProductModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    "./src/app/products/state/product.effects.ts"); // NGRX
  ...
  /***/
  "./src/app/products/product.service.ts": function srcAppProductsProductServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  "./src/app/products/state/product.actions.ts": function srcAppProductsStateProductActionsTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var toggleProductCode = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])("[Product] Toggle product code");
    var setCurrentProduct = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])("[Product] Set Current product", Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
    var clearCurrentProduct = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])("[Product] Clear Current product");
    var InitializeCurrentProduct = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])("[Product] Initialize Current product");
    var loadProducts = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])("[Product] Load");
    var loadProductsSuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])("[Product] Load Success", Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
    var loadProductsFailure = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])("[Product] Load Fail", Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
    /***/
  },

  /***/
  "./src/app/products/state/product.effects.ts": function srcAppProductsStateProductEffectsTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _state_product_actions__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../state/product.actions */
    "./src/app/products/state/product.actions.ts");
    /* harmony import */
    ...
    var ProductEffects = function ProductEffects(actions$, _productService) {
      var _this5 = this;
      ...
      this.loadProducts$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_1__["createEffect"])(function () {
        return _this5.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_1__["ofType"])(_state_product_actions__WEBPACK_IMPORTED_MODULE_4__["loadProducts"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function () {
          return _this5._productService.getProducts().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (products) {
            return _state_product_actions__WEBPACK_IMPORTED_MODULE_4__["loadProductsSuccess"]({
              products: products
            });
          }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (error) {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(_state_product_actions__WEBPACK_IMPORTED_MODULE_4__["loadProductsFailure"]({
              error: error
            }));
          }));
        }));
    ...
    ProductEffects.ɵfac = function ProductEffects_Factory(t) {
      return new (t || ProductEffects)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_ngrx_effects__WEBPACK_IMPORTED_MODULE_1__["Actions"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_product_service__WEBPACK_IMPORTED_MODULE_5__["ProductService"]));
    };
  ...
  /***/
  "./src/app/products/state/product.reducer.ts": function srcAppProductsStateProductReducerTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _product_actions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./product.actions */
    "./src/app/products/state/product.actions.ts");
    ...
    var getProductFeatureState = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createFeatureSelector"])("products"); // now cat create any selector for any ProductState property

    var getShowProductCode = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(getProductFeatureState, // state function is a projector function
    function (state) {
      return state.showProductsCode;
    });
    var getCurrentProduct = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(getProductFeatureState, function (state) {
    ...
    var productReducer = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createReducer"])(initialState, //Initial State for showProductCode
    Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_product_actions__WEBPACK_IMPORTED_MODULE_1__["toggleProductCode"], function (state) {
    ...
    }), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_product_actions__WEBPACK_IMPORTED_MODULE_1__["setCurrentProduct"], function (state, action) {
      return Object.assign(Object.assign({}, state), {
        currentProduct: action.product
      });
    }), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_product_actions__WEBPACK_IMPORTED_MODULE_1__["clearCurrentProduct"], function (state) {
      return Object.assign(Object.assign({}, state), {
        currentProduct: null
      });
    }), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_product_actions__WEBPACK_IMPORTED_MODULE_1__["InitializeCurrentProduct"], function (state) {
      return Object.assign(Object.assign({}, state), {
        currentProduct: {
          id: 0,
          productName: "",
    ...
    }), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_product_actions__WEBPACK_IMPORTED_MODULE_1__["loadProductsSuccess"], function (state, action) {
      return Object.assign(Object.assign({}, state), {
        products: action.products,
        error: null
      });
    }), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_product_actions__WEBPACK_IMPORTED_MODULE_1__["loadProductsFailure"], function (state, action) {
      return Object.assign(Object.assign({}, state), {
        products: [],
        error: action.error
      });
  ...
  /***/
  "./src/app/shared/generic-validator.ts": function srcAppSharedGenericValidatorTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
          ...
          var _loop = function _loop(controlKey) {
            if (container.controls.hasOwnProperty(controlKey)) {
              ...
              if (c instanceof _angular_forms__WEBPACK_IMPORTED_MODULE_0__["FormGroup"]) {
                var childMessages = _this6.processMessages(c);

                Object.assign(messages, childMessages);
              } else {
                // Only validate if there are validation messages for the control
                if (_this6.validationMessages[controlKey]) {
                  messages[controlKey] = '';

                  if ((c.dirty || c.touched) && c.errors) {
                    Object.keys(c.errors).map(function (messageKey) {
                      if (_this6.validationMessages[controlKey][messageKey]) {
                        messages[controlKey] += _this6.validationMessages[controlKey][messageKey] + ' ';
                      }
                    });
                  }
                }
  ...
  /***/
  "./src/app/shared/number.validator.ts": function srcAppSharedNumberValidatorTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
